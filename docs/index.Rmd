...
You can download all the necessary files from <https://github.com/tcfyip/LSM-XGB-HCC-score>. Please click "Code" and then "Download ZIP". ![Click Code and Download ZIP](placeholder.png){width="30%"}

Then you can put all the downloaded files in the same directory of your local computer and run the following R codes with R installed. Or you may want to fork the whole repository to your GitHub. The R codes are tested in R4.0.3 and R4.0.5.
